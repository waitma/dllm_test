...
- Optional but preferred fields: `chain_roles`, `targets`, `split`, `labels`, `regions`, and `metadata`.
...
- `targets` should list chain indices participating in denoising/generation; default is all chains.
