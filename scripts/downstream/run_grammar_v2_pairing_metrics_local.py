"""Evaluate saved grammar-v2 light-pairing CSVs with comp_chain generation_eval locally.

Run:
  source activate /vepfs-mlp2/c20250601/251105016/conda/envs/protenix_abtcr
  python /vepfs-mlp2/c20250601/251105016/project/dllm_test/scripts/downstream/run_grammar_v2_pairing_metrics_local.py
"""
...
def main() -> None:
    ...
    (OUT_DIR / "grammar_v2_pairing_metrics_summary.json").write_text(
